...
<body>
  ...
  <div class="container">
    ...
    <div class="content-container">
      ...
      $query1 = "UPDATE user SET std_id='$std_id' WHERE std_id = '$std_id';";
      $query2 = "UPDATE user SET firstname='$firstname' WHERE std_id = '$std_id';";
      $query3 = "UPDATE user SET lastname='$lastname' WHERE std_id = '$std_id';";
      $query4 = "UPDATE user SET email='$email' WHERE std_id = '$std_id';";
      $query5 = "UPDATE user SET gen ='$gen' WHERE std_id = '$std_id';";
      $query6 = "UPDATE user SET career ='$career' WHERE std_id = '$std_id';";
      ...
      $query7 = "SELECT * FROM career WHERE std_id = '$std_id'AND career='$career';";
      $run = $db->prepare($query7);
      $run->execute();
      ...
      if ($row['std_id'] == $std_id) {
        ...
        $timestamp = time();
        $query7 = "INSERT INTO career (std_id,career,timestamp) VALUES ('$std_id','$career',$timestamp);";
        $run = $db->prepare($query7);
        $run->execute();
        echo "<br><br>";
        echo "<table>";
      ...
      ?>
      <form class="col s12 " action="searchdatabystudentid.php" method="post" enctype="multipart/form-data">
        <br><br>
        <div class="row">
          <button class="btn waves-effect waves-light col s2 offset-s5" type="submit" name="action">กลับไปหน้าแก้ไขข้อมูล
